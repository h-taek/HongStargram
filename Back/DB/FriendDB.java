...
public class FriendDB {
    ...
    public String getFriendRequest(String id) {
        ...
        try (Connection conn = DBManager.getConnection();
            ...
            try (ResultSet rs_receive = pstmt_receive.executeQuery()) {
            ...
            try (ResultSet rs_send = pstmt_send.executeQuery()) {
    ...
    public void acceptFriendRequest(String from_id, String to_id) {
        ...
        try (Connection conn = DBManager.getConnection();
            ...
            Gson gson = new Gson();
            List<Integer> post_ids_int_list = gson.fromJson(old_readable_posts_str, new TypeToken<List<Integer>>() {
            }.getType());
            post_ids_int_list.addAll(gson.fromJson(add_readable_psots_str, new TypeToken<List<Integer>>() {
            }.getType()));
            ...
            List<Integer> sorted_post_ids = gson.fromJson(sorted_post_ids_str, new TypeToken<List<Integer>>() {
            }.getType());
            ...
            post_ids_int_list = gson.fromJson(old_readable_posts_str, new TypeToken<List<Integer>>() {
            }.getType());
            post_ids_int_list.addAll(gson.fromJson(add_readable_psots_str, new TypeToken<List<Integer>>() {
            }.getType()));
            ...
            sorted_post_ids = gson.fromJson(sorted_post_ids_str, new TypeToken<List<Integer>>() {
            }.getType());
